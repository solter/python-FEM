...
FVM.FEMcalc("setups/fin401A.setup",True)
FVM.FEMcalc("setups/fin401B.setup",True)
FVM.FEMcalc("setups/fin801A.setup",True)
FVM.FEMcalc("setups/fin801B.setup",True)
FVM.FEMcalc("setups/fin801A2.setup",True)
FVM.FEMcalc("setups/fin801B2.setup",True)
